        ...
        <div className='app-shell flex flex-col size-full min-h-0'>
          ...
          <ArcoLayout className={'size-full layout flex-1 min-h-0'}>
            ...
            >
              ...
              >
                <div
                  data-testid='product-brand-icon'
                  className={classNames('shrink-0 size-32px relative rd-0.5rem overflow-hidden', {
                    '!size-24px': collapsed,
                  })}
                  onClick={onClick}
                >
                  <img src={brand.logoUrl} alt='' className='block size-full object-contain' />
                </div>
                {isSettingsRoute ? (
                  ...
                  <div className='text-16px text-t-primary collapsed-hidden font-semibold'>{productName}</div>
                )}
                {isMobile && !collapsed && (
                  <button
                    type='button'
